...
Public Class AccountController
    ...
    Public Async Function Register(model As RegisterViewModel) As Task(Of ActionResult)
        If ModelState.IsValid Then
            ' Crear un inicio de sesión local antes de iniciar la sesión de usuario
    ...
    Public Function Manage(ByVal message As ManageMessageId?) As ActionResult
        ViewData("StatusMessage") =
            If(message = ManageMessageId.ChangePasswordSuccess, "La contraseña se ha cambiado.", _
                If(message = ManageMessageId.SetPasswordSuccess, "La contraseña se ha establecido.", _
                    If(message = ManageMessageId.RemoveLoginSuccess, "El inicio de sesión externo se ha quitado.", _
                        If(message = ManageMessageId.UnknownError, "Se produjo un error.", _
                        ""))))
    ...
    Public Async Function Manage(model As ManageUserViewModel) As Task(Of ActionResult)
        ...
        If hasLocalLogin Then
            ...
            End If
        Else
            ' El usuario no tiene contraseña local. Quite los errores de validación producidos porque falta un campo OldPassword
